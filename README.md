...
Наглядно ознакомиться с проектом можно [здесь](http://jmuriki.pythonanywhere.com), а [тут располагается панель администратора](http://jmuriki.pythonanywhere.com/admin). Логин для входа с правом просмотра - `12345user`, пароль - `12345password`.
